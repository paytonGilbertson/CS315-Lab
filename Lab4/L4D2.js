...
function render() {
   ...
   gl.uniform4fv(light.ambient, mult(vec4(0.2, 0.2, 0.2, 1.0), white));
   ...
   cubeTF = mult(cubeTF, translate(4.0, 0.0, 0.0));

   var lpos = vec4(0.0, 0.0, 0.0, 1.0);
   ...
   gl.uniform4fv(material.ambient, mult(vec4(0.8, 0.8, 0.8, 1.0), lightred));
